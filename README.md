...
### 安装方法：
``` Bash
wget --no-check-certificate -O dnsmasq_sniproxy.sh https://raw.githubusercontent.com/wulimaxh/dnsmasq_sniproxy_install/dev/dnsmasq_sniproxy.sh && bash dnsmasq_sniproxy.sh -i
```

### 卸载方法：
``` Bash
wget --no-check-certificate -O dnsmasq_sniproxy.sh https://raw.githubusercontent.com/wulimaxh/dnsmasq_sniproxy_install/dev/dnsmasq_sniproxy.sh && bash dnsmasq_sniproxy.sh -u
```
